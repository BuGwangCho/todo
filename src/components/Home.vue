<template>
    <div>
        <ul id="menu">
            <li data-menuanchor="page1" class="active"><a href="#page1">Login Log</a></li>
            <li data-menuanchor="page2"><a href="#page2">Page Log</a></li>
            <li data-menuanchor="page3"><a href="#page3">Scrap Log</a></li>
            <li>
                <a href="/">login</a>
            </li>
        </ul>
...
<script>
  ...
  import ScrapLog from './log/scrap'
  export default {
    name: 'app',
    components : {
      FullPage,
